...
#Second parameter is folder to mount as shared folder. Intended to support really stupid programs like Autodesk products.
...
VBoxManage sharedfolder add "$VM_Name" --name "appFolder" --hostpath "$2"
